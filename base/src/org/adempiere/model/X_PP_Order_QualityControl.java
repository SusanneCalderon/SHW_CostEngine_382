...
/** Generated Model for PP_Order_QualityControl
 *  @author Adempiere (generated) 
 *  @version Release 1.0.0 - $Id$ */
public class X_PP_Order_QualityControl extends PO implements I_PP_Order_QualityControl, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20131019L;

    /** Standard Constructor */
    public X_PP_Order_QualityControl (Properties ctx, int PP_Order_QualityControl_ID, String trxName)
    {
      super (ctx, PP_Order_QualityControl_ID, trxName);
      /** if (PP_Order_QualityControl_ID == 0)
        {
			setPP_Order_QualityControl_ID (0);
        } */
    }

    /** Load Constructor */
    public X_PP_Order_QualityControl (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PP_Order_QualityControl[")
	...
	public void setPP_Order_QualityControl_ID (int PP_Order_QualityControl_ID)
	{
		if (PP_Order_QualityControl_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_PP_Order_QualityControl_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_PP_Order_QualityControl_ID, Integer.valueOf(PP_Order_QualityControl_ID));
	}
