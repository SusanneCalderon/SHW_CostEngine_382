 ...
 */
public class VAllocationSHW extends AllocationSHW
	implements FormPanel, ActionListener, TableModelListener, VetoableChangeListener
{
	...
	private VLookup bpartnerPaymentSearch = null;
	private JLabel bpartnerLabelPayment = new JLabel();
	/**	Confirm Panel		*/
	...
	private void jbInit() throws Exception
	{
		...
		//parameterPanel.add(organizationLabel, new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0
		//		,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5,5,5,5), 0, 0));
		parameterPanel.add(bpartnerLabelPayment, new GridBagConstraints(7, 0, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 0, 5, 5), 0, 0));
			parameterPanel.add(bpartnerPaymentSearch, new GridBagConstraints(8, 0, 1, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 0, 5, 5), 0, 0));
	...
	public void dynInit() throws Exception
	{
		...
		MLookup bpartnerPayment = MLookupFactory.get(Env.getCtx(), getWindowNo(), 1000779, 
				DisplayType.Search, Env.getLanguage(Env.getCtx()), "C_BPartner_ID", 
				138, false, "");
		bpartnerPaymentSearch = new VLookup("C_BPartnerPayment_ID", true, false, true, bpartnerPayment);
		bpartnerPaymentSearch.addVetoableChangeListener(this);
	...
	public void vetoableChange (PropertyChangeEvent e)
	{
		...
		if (name.equals("C_BPartner_ID"))
		{
			...
			m_C_BPartnerPayment_ID = ((Integer)value).intValue();
			loadBPartner();
		}
