 ...
 */
public class Callout_Z_SHW_ReadRS232_COMMAPI extends CalloutEngine
{
	/**
	 *	LeerBascula 
	...
	public  String LeerBascula (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		String portDescriptor = "SHW: PESAR-COMMAPI";
	    ...
	    //String outputString = "123456.78 PPPPPP";  // TEST
        ...
        try {
            ...
            if (weightString.isEmpty())
            	...
            	weightDouble = Double.valueOf(weightString);
			...
			mTab.setValue("Description", weightDouble); // als Code
