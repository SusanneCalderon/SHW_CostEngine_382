 ...
 */
public class SHW_InOutCreateInvoice extends SvrProcess
{
	/**	Shipment					*/
	...
	protected String doIt () throws Exception
	{
		...
		if (ship.getC_Order_ID() > 0 && ship.getC_Order().getC_DocTypeTarget().getC_DocTypeInvoice_ID() > 0)
		{
			invoice.setC_DocTypeTarget_ID(ship.getC_Order().getC_DocTypeTarget().getC_DocTypeInvoice_ID());
			invoice.saveEx();
		}
