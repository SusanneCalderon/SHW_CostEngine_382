...
public class Language implements Serializable
{
	...
	private static final String AD_Language_es_NI = "es_NI";
	// SHW 06. Dez. 2007
	...
	static private Language[]   s_languages = {
		...
		new Language ("Espa\u00f1ol",
			...
			MediaSize.ISO.A4),
			// SHW 06. Dez. 2007
		new Language ("Espa\u00f1ol (El Salvador)",
		    AD_Language_es_SV,  new Locale("es","SV"), new Boolean(true), "dd/MM/yyyy",
			MediaSize.NA.LETTER),
		new Language ("Espa\u00f1ol (NI)",
		    AD_Language_es_NI,  new Locale("es","NI"), new Boolean(true), "dd/MM/yyyy",
			MediaSize.NA.LETTER),
			// SHW 06. Dez. 2007
	...
	public SimpleDateFormat getDateTimeFormat()
	{
		...
		retValue.applyPattern("dd.MM.yyyy HH:mm:ss");
