...
/**
 *	Generate Shipment from OrderLines
 *	
 *  @author Susanne Calderon
 */
public class SB_InvoiceGenerate extends SvrProcess
{
	/**	Date Invoiced			*/
		...
		BigDecimal qtyInvoiced, BigDecimal qtyEntered)
	{
		if (m_invoice == null)
		{
			...
			if (!p_ConsolidateDocument)
				m_invoice.setC_Order_ID(order.getC_Order_ID());
			if (!m_invoice.save())
	...
	private void AssignPrepayments()
	{}
