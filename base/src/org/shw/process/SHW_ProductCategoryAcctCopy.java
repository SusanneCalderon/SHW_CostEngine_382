 ...
 */
public class SHW_ProductCategoryAcctCopy extends SvrProcess
{
	/** Product Categpory			*/
	...
	protected String doIt () throws Exception
	{
		...
		if (p_M_Product_Category_ID !=0)
			whereClause = "M_product_category_ID = " + p_M_Product_Category_ID;
		...
		{		
			String sql = "UPDATE M_Product_Acct pa "
					...
					+ " AND p.M_Product_Category_ID=" + cat.getM_Product_Category_ID() + ")";
